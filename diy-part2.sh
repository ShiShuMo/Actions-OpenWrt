...
sed -i 's/Lean/莫诗书/g' package/lean/v2ray/Makefile;sed -i 's/R21.2.1/Powered By 莫诗书 (admin@52mss.cn)/g' package/lean/default-settings/files/zzz-default-settings;sed -i 's/192.168.1.1/192.168.2.1/g' package/base-files/files/bin/config_generate;
#取消bootstrap为默认主题
